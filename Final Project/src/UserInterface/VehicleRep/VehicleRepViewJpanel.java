...
public class VehicleRepViewJpanel extends javax.swing.JPanel {
     ...
     */
    EcoSystem system;
    public VehicleRepViewJpanel(EcoSystem system) {
        initComponents();
        this.system = system;
        populateTable();
    }
    ...
    public void populateTable()
    {
        ...
        for(Rental rental: rentals)
        {
            ...
            row[0] = rental.getVehicleName();
            row[1] = rental.getVehicle().getCategory();
            row[2] = system.getCustomerDirectory().getCustomerById(rental.getCustomerId()).getName();
            model.addRow(row);
            revenue += rental.getTotalPrice();
        }
        jTextField1.setText(String.valueOf(rentals.size()));
        jTextField2.setText(String.format("%.2f", revenue));
    }

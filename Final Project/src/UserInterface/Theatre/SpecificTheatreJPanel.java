...
public class SpecificTheatreJPanel extends javax.swing.JPanel {
    ...
    String movieName;
    int noOfTickets;
    public SpecificTheatreJPanel(EcoSystem system, Theatre theatre) {
        initComponents();
        this.system = system;
            ...
            public void populateDetails()
    {
        ...
        jTextField4.setText(theatre.getName());
        jTextField1.setText(theatre.getLocation());
        jTextField6.setText(theatre.getScreenTech());
        populateMovieDetails(theatre.getId());
        ...
        if (selectedRow >= 0) { // if a row is actually selected
            movieName = jTable1.getValueAt(selectedRow, 0).toString();
            Movie movie = system.getMovies().findMovieByName(movieName);
            moviePrice = movie.getPrice();
            jTextField5.setText(movie.getName());
            jTextField7.setText(movie.getTiming());
        }
    }
        ...
        public void populateMovieDetails(int id)
    {
        ArrayList<Movie> moviesForTheatre = system.getMovies().getMoviesForTheatre(theatre.getId());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else
        {
            ...
            noOfTickets = Integer.parseInt(jTextField8.getText());
            booking.setNoOfTickets(noOfTickets);
            booking.setTheatreId(theatre.getId());
            Float total = noOfTickets * moviePrice;

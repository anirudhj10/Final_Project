...
public class ConfigureASystem {
    ...
    public static EcoSystem configure() {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            museum.setTiming("2023-" + (ran.nextInt(12) + 1) + "-" + (ran.nextInt(28) + 1) + " " +
                            (ran.nextInt(24)) + ":" + (ran.nextInt(60)));
            float entryFee = Math.round((ran.nextFloat() * (100 - 10) + 10) * 100.0f) / 100.0f; // Price range from $10.00 to $100.00
            museum.setEntryFee(entryFee);
            museums.add(museum);
        }
...
;
        ...
        for (int i = 0; i < 100; i++) {
            ...
            int noOfHours = random.nextInt(10) + 1; 
            rental.setVehicle(vehicle);
            rental.setNoOfHours(noOfHours);
            rental.setTotalPrice(vehicle.getHourlyPrice() * noOfHours);
